...
function Nav(props) {
 ...
 useSWR(props.fetchUrl, (url) => axios.get(url).then((respond) => setMovies(respond.data.results.slice(0, 7))));
  ...
  return (
    <div className={`nav ${show && "nav__black"}`}>
      ...
      <div className="nav__row">
        <h5 className="nav__home" onClick={callHome}> Home </h5>
        <h5 className="nav__series nav__popup__hide" onClick={callSeries}> Series </h5>
        <h5 className="nav__films nav__popup__hide" onClick={callFilms}> Films </h5>
        <h5 className="nav__news nav__popup__hide" onClick={callPopular}> Popular </h5>
        ...
        <div onMouseOver={handleNavPopupShow} onMouseOut={handleNavPopupHide} className="nav__popup__list">
          ...
          <h5 className={`nav__news ${showNavListPopup && "nav__popup__show"}`}> Popular </h5>
